...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: "/products/pp-culture-containers.webp",
    specs: {
      capacity: "160mL / 200mL / 300mL / 500mL / 750mL / 1000mL / 不适用 / 500mL / 750mL / 1000mL",
      height: "68mm / 65mm / 73mm / 90mm / 110mm / 124mm / 45mm / 85mm / 95mm / 120mm",
      bottomDiameter: "55mm / 73mm / 77mm / 92mm / 96mm / 105mm / 不适用 / 80×80mm / 88×88mm / 92×92mm",
      material: "PP",
      compatibleLid: "/"
    },
    variants: ["68×67×55mm", "65×80×73mm", "73×100×77mm", "90×120×92mm", "110×122×96mm", "124×130×105mm", "87×60×45mm", "95×95×85mm", "110×110×95mm", "110×110×120mm"],
    related: ["pp-culture-boxes", "heat-seal-culture-bags", "culture-lids"],
    zh: {
      name: "PP组培容器",
      description: "富龙塑业PP组培容器采用优质PP材料制造，可进行高温高压灭菌。在规范操作、正确灭菌及合理使用条件下，产品可重复使用数次，适用于科研实验、植物组织培养、商业化组培生产及日常培养管理。对于需要长期使用和标准化管理的培养流程，可帮助降低综合使用成本。",
      features: ["优质PP材质", "可高温高压灭菌", "规范条件下可重复使用数次", "适用于科研与商业化组培"],
    ...
    en: {
      ...
      description: "These polypropylene (PP) tissue culture containers are designed for laboratory tissue culture, commercial micropropagation, and routine culture management. The products are autoclavable and can be reused several times under proper operating, sterilization, and handling conditions. For standardized workflows that require repeated use, they provide a practical and cost-effective culture vessel option.",
      features: ["Polypropylene (PP) material", "Autoclavable", "Reusable several times under proper conditions", "Cost-effective for routine culture management"],
  ...
  },
  {
    ...
    specs: {
      capacity: "500mL / 600mL / 800mL / 不适用 / 不适用",
      topDimensions: "120mm / 120mm / 120mm / 100mm / 120mm",
      bottomDimensions: "80mm / 90mm / 90mm / 80mm / 88mm",
      height: "80mm / 80mm / 100mm / 100mm / 60mm",
      bottomDiameter: "80mm / 90mm / 90mm / 80mm / 88mm",
      material: "PP",
      compatibleLid: "不适用",
      filterMembraneDiameter: "不适用 / 不适用 / 不适用 / 不适用 / 不适用"
    },
    variants: ["120×80×80mm", "120×90×80mm", "120×90×100mm", "100×80×100mm", "120×88×60mm"],
    related: ["pp-culture-containers", "heat-seal-culture-bags", "culture-baskets"],
    zh: {
      name: "一次性PP培养盒",
      description: "本系列产品主要用于一次性植物组织培养，无需清洗，可减少不同批次之间的交叉污染风险，适用于商业化组培、高周转生产及批量培养。其中，PP-BOX-10080100 属于热封培养盒，需要搭配封口膜及热封设备完成封口；其它规格按照实际产品配置用于相应培养流程。",
      features: ["一次性植物组织培养", "无需清洗", "减少交叉污染风险", "适用于高周转批量培养"],
      seoTitle: "一次性PP培养盒 | 富龙塑业",
      metaDescription: "富龙塑业一次性PP培养盒无需清洗，可减少交叉污染风险，适用于商业化组培、高周转生产及批量培养。"
    },
    en: {
      name: "Disposable PP Culture Boxes",
      description: "Disposable PP Culture Boxes are intended for single-use tissue culture workflows where no cleaning is required and reducing the risk of cross-contamination between batches is important. They are suitable for high-throughput tissue culture production, commercial micropropagation, and batch cultivation. PP-BOX-10080100 is a heat-seal culture box used with sealing film and a heat sealer; other models should be selected according to their actual product configuration.",
      features: ["Disposable PP Culture Boxes", "Single-use workflow", "No cleaning required", "Reduce the risk of cross-contamination"],
      seoTitle: "Disposable PP Culture Boxes | Fulong Plastic",
      metaDescription: "Fulong Disposable PP Culture Boxes are single-use tissue culture containers for commercial micropropagation, high-throughput production, and reduced cross-contamination risk."
    }
  },
  {
...
export const productSpecGroups: ProductSpecGroup[] = [
  {
    ...
    cards: [
      { id: "pc-tissue-culture-bottles-1", image: "/products/pc-bottles/96x60.webp", imageFileName: "96x60.jpg", sourceName: "96×60mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-9660", capacity: "145mL", openingDiameter: "/", bottomDiameter: "60mm", height: "96mm", material: "PC", compatibleLid: "41#" } },
      { id: "pc-tissue-culture-bottles-2", image: "/products/pc-bottles/80x60.webp", imageFileName: "80x60.jpg", sourceName: "80×60mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-8060", capacity: "160mL", openingDiameter: "/", bottomDiameter: "60mm", height: "80mm", material: "PC", compatibleLid: "53#" } },
      { id: "pc-tissue-culture-bottles-3", image: "/products/pc-bottles/57x77x77.webp", imageFileName: "57x77x77.jpg", sourceName: "57×77×77mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-577777", capacity: "180mL", openingDiameter: "/", bottomDiameter: "77x77mm", height: "57mm", material: "PC", compatibleLid: "58#" } },
      { id: "pc-tissue-culture-bottles-4", image: "/products/pc-bottles/80x77.webp", imageFileName: "80x77.jpg", sourceName: "80×77mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-8077", capacity: "240mL", openingDiameter: "/", bottomDiameter: "77mm", height: "80mm", material: "PC", compatibleLid: "60#" } },
      { id: "pc-tissue-culture-bottles-5", image: "/products/pc-bottles/72x77x77.webp", imageFileName: "72x77x77.jpg", sourceName: "72×77×77mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-727777", capacity: "250mL", openingDiameter: "/", bottomDiameter: "77x77mm", height: "72mm", material: "PC", compatibleLid: "72#" } },
      { id: "pc-tissue-culture-bottles-6", image: "/products/pc-bottles/98x67.webp", imageFileName: "98x67.jpg", sourceName: "98×67mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-9867", capacity: "250mL", openingDiameter: "/", bottomDiameter: "67mm", height: "98mm", material: "PC", compatibleLid: "61#" } },
      ...
      { id: "pc-tissue-culture-bottles-13", image: "/products/pc-bottles/100x95x95.webp", imageFileName: "100x95x95.jpg", sourceName: "100×95×95mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-1009595", capacity: "600mL", openingDiameter: "/", bottomDiameter: "95x95mm", height: "100mm", material: "PC", compatibleLid: "77#" } },
      { id: "pc-tissue-culture-bottles-14", image: "/products/pc-bottles/110x95x95.webp", imageFileName: "110x95x95.jpg", sourceName: "110×95×95mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-1109595", capacity: "650mL", openingDiameter: "/", bottomDiameter: "95x95mm", height: "110mm", material: "PC", compatibleLid: "95#" } },
      { id: "pc-tissue-culture-bottles-15", image: "/products/pc-bottles/145x96.webp", imageFileName: "145x96.jpg", sourceName: "145×96mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-14596", capacity: "800mL", openingDiameter: "/", bottomDiameter: "96mm", height: "145mm", material: "PC", compatibleLid: "77#" } },
      { id: "pc-tissue-culture-bottles-16", image: "/products/pc-bottles/185x96.webp", imageFileName: "185x96.jpg", sourceName: "185×96mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-BTL-18596", capacity: "1000mL", openingDiameter: "/", bottomDiameter: "96mm", height: "185mm", material: "PC", compatibleLid: "77#" } },
    ]
  },
  {
    category: "pc-series",
    ...
    cards: [
      { id: "pc-culture-tubes-1", image: "/products/pc-tubes/100x30.webp", imageFileName: "100x30.jpg", sourceName: "100×30mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-TUB-10030", capacity: "50mL", openingDiameter: "/", bottomDiameter: "30mm", height: "100mm", material: "PC", compatibleLid: "30#" } },
      { id: "pc-culture-tubes-2", image: "/products/pc-tubes/150x30.webp", imageFileName: "150x30.jpg", sourceName: "150×30mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-TUB-15030", capacity: "80mL", openingDiameter: "/", bottomDiameter: "30mm", height: "150mm", material: "PC", compatibleLid: "30#" } },
      { id: "pc-culture-tubes-3", image: "/products/pc-tubes/200x30.webp", imageFileName: "200x30.jpg", sourceName: "200×30mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-TUB-20030", capacity: "100mL", openingDiameter: "/", bottomDiameter: "30mm", height: "200mm", material: "PC", compatibleLid: "30#" } },
      { id: "pc-culture-tubes-4", image: "/products/pc-tubes/91x47.webp", imageFileName: "91x47.jpg", sourceName: "91×47mm", hiddenFields: ["openingDiameter"], fields: { productCode: "PC-TUB-9147", capacity: "120mL", openingDiameter: "/", bottomDiameter: "47mm", height: "91mm", material: "PC", compatibleLid: "40#" } },
    ]
  },
  {
    category: "pc-series",
    ...
    cards: [
      { id: "pc-wide-mouth-culture-cups-1", image: "/products/pc-wide-mouth-cups/65x90x82.webp", imageFileName: "65x90x82.jpg", sourceName: "65×90×82mm", fields: { productCode: "PC-CUP-659082", capacity: "340mL", openingDiameter: "90mm", bottomDiameter: "82mm", height: "65mm", material: "PC", compatibleLid: "90#" } },
      { id: "pc-wide-mouth-culture-cups-2", image: "/products/pc-wide-mouth-cups/85x90x81.webp", imageFileName: "85x90x81.jpg", sourceName: "85×90×81mm", fields: { productCode: "PC-CUP-859081", capacity: "430mL", openingDiameter: "90mm", bottomDiameter: "81mm", height: "85mm", material: "PC", compatibleLid: "90#" } },
      { id: "pc-wide-mouth-culture-cups-3", image: "/products/pc-wide-mouth-cups/95x90x83-vent.webp", imageFileName: "95x90x83-vent.jpg", sourceName: "95×90×83mm", fields: { productCode: "PC-CUP-959083-V", capacity: "/", openingDiameter: "90mm", bottomDiameter: "83mm", height: "95mm", material: "PC", compatibleLid: "透气款" } },
      { id: "pc-wide-mouth-culture-cups-4", image: "/products/pc-wide-mouth-cups/125x90x83-vent.webp", imageFileName: "125x90x83-vent.jpg", sourceName: "125×90×83mm", fields: { productCode: "PC-CUP-1259083-V", capacity: "/", openingDiameter: "90mm", bottomDiameter: "83mm", height: "125mm", material: "PC", compatibleLid: "透气款" } },
      { id: "pc-wide-mouth-culture-cups-5", image: "/products/pc-wide-mouth-cups/95x90x83-solid.webp", imageFileName: "95x90x83-solid.jpg", sourceName: "95×90×83mm", fields: { productCode: "PC-CUP-959083-S", capacity: "/", openingDiameter: "90mm", bottomDiameter: "83mm", height: "95mm", material: "PC", compatibleLid: "密封款" } },
      { id: "pc-wide-mouth-culture-cups-6", image: "/products/pc-wide-mouth-cups/125x90x83-solid.webp", imageFileName: "125x90x83-solid.jpg", sourceName: "125×90×83mm", fields: { productCode: "PC-CUP-1259083-S", capacity: "/", openingDiameter: "90mm", bottomDiameter: "83mm", height: "125mm", material: "PC", compatibleLid: "密封款" } },
    ]
  },
  {
    category: "pp-series",
    ...
    zh: { name: "PP组培容器", description: "富龙塑业PP组培容器采用优质PP材料制造，可进行高温高压灭菌，适用于科研实验、植物组织培养及商业化组培生产。" },
    en: { name: "PP Tissue Culture Containers", description: "Polypropylene tissue culture containers for laboratory tissue culture, commercial micropropagation, and routine culture management." },
    cards: [
      { id: "pp-culture-containers-1", image: "/products/pp-containers/68x67x55.webp", imageFileName: "68x67x55.jpg", sourceName: "68×67×55mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-686755", capacity: "160mL", openingDiameter: "67mm", bottomDiameter: "55mm", height: "68mm", material: "PP", filterMembraneDiameter: "1cm", closureType: "按压式", compatibleLid: "/" } },
      { id: "pp-culture-containers-3", image: "/products/pp-containers/73x100x77.webp", imageFileName: "73x100x77.jpg", sourceName: "73×100×77mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-7310077", capacity: "300mL", openingDiameter: "100mm", bottomDiameter: "77mm", height: "73mm", material: "PP", filterMembraneDiameter: "2cm", closureType: "按压式", compatibleLid: "/" } },
      { id: "pp-culture-containers-4", image: "/products/pp-containers/90x120x92.webp", imageFileName: "90x120x92.jpg", sourceName: "90×120×92mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-9012092", capacity: "500mL", openingDiameter: "120mm", bottomDiameter: "92mm", height: "90mm", material: "PP", filterMembraneDiameter: "3cm", closureType: "按压式", compatibleLid: "/" } },
      { id: "pp-culture-containers-5", image: "/products/pp-containers/110x122x96.webp", imageFileName: "110x122x96.jpg", sourceName: "110×122×96mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-11012296", capacity: "750mL", openingDiameter: "122mm", bottomDiameter: "96mm", height: "110mm", material: "PP", filterMembraneDiameter: "3cm", closureType: "按压式", compatibleLid: "/" } },
      { id: "pp-culture-containers-6", image: "/products/pp-containers/124x130x105.webp", imageFileName: "124x130x105.jpg", sourceName: "124×130×105mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-124130105", capacity: "1000mL", openingDiameter: "130mm", bottomDiameter: "105mm", height: "124mm", material: "PP", filterMembraneDiameter: "3cm", closureType: "按压式", compatibleLid: "/" } },
      { id: "pp-culture-containers-7", image: "/products/pp-culture-boxes/87x60x45.webp", imageFileName: "87x60x45.JPG", sourceName: "87×60×45mm", fields: { productCode: "PP-BOX-876045", capacity: "不适用", topDimensions: "87×60mm", bottomDimensions: "不适用", height: "45mm", material: "PP", closureType: "按压式", filterMembraneDiameter: "1cm" } },
      { id: "pp-culture-containers-8", image: "/products/pp-culture-boxes/95x80x85.JPG", imageFileName: "95x80x85.JPG", sourceName: "95×95×85mm", fields: { productCode: "PP-BOX-958085-M02", capacity: "500mL", topDimensions: "95×95mm", bottomDimensions: "80×80mm", height: "85mm", material: "PP", closureType: "按压式", filterMembraneDiameter: "2cm" } },
      ...
      { id: "pp-culture-containers-2", image: "/products/pp-containers/65x80x73.webp", imageFileName: "65x80x73.jpg", sourceName: "65×80×73mm", hiddenFields: ["compatibleLid"], fields: { productCode: "PP-CON-658073", capacity: "200mL", openingDiameter: "80mm", bottomDiameter: "73mm", height: "65mm", material: "PP", filterMembraneDiameter: "2cm", closureType: "旋拧式", compatibleLid: "/" } },
      { id: "pp-culture-containers-11", image: "/products/pp-containers/76x90x70.JPG", imageFileName: "76x90x70.JPG", sourceName: "76×90×70mm", fields: { productCode: "PP-CON-769070", capacity: "330mL", topDiameter: "90mm", bottomDiameter: "70mm", height: "76mm", material: "PP", filterMembraneDiameter: "1cm", closureType: "旋拧式" } },
    ]
  },
  {
    category: "pp-series",
    slug: "pp-culture-boxes",
    image: ppBoxImage,
    zh: { name: "一次性PP培养盒", description: "一次性PP培养盒主要用于一次性植物组织培养，无需清洗，适用于商业化组培、高周转生产及批量培养。" },
    en: { name: "Disposable PP Culture Boxes", description: "Disposable PP Culture Boxes for single-use tissue culture workflows, high-throughput production, and commercial micropropagation." },
    cards: [
      { id: "pp-culture-boxes-1", image: "/products/pp-culture-boxes/120x80x80.webp", imageFileName: "120x80x80.JPG", sourceName: "120×80×80mm", fields: { productCode: "PP-BOX-1208080", capacity: "500mL", topDimensions: "120mm", bottomDimensions: "80mm", height: "80mm", material: "PP", filterMembraneDiameter: "2cm" } },
      { id: "pp-culture-boxes-2", image: "/products/pp-culture-boxes/120x90x80.webp", imageFileName: "120x90x80.JPG", sourceName: "120×90×80mm", fields: { productCode: "PP-BOX-1209080", capacity: "600mL", topDimensions: "120mm", bottomDimensions: "90mm", height: "80mm", material: "PP", filterMembraneDiameter: "2cm" } },
      { id: "pp-culture-boxes-3", image: "/products/pp-culture-boxes/120x90x100.webp", imageFileName: "120x90x100.JPG", sourceName: "120×90×100mm", fields: { productCode: "PP-BOX-12090100", capacity: "800mL", topDimensions: "120mm", bottomDimensions: "90mm", height: "100mm", material: "PP", filterMembraneDiameter: "2cm" } },
      ...
      { id: "pp-culture-boxes-5", image: "/products/pp-culture-boxes/120x88x60.webp", imageFileName: "120x88x60.JPG", sourceName: "120×88×60mm", fields: { productCode: "PP-BOX-1208860", capacity: "500mL", topDimensions: "120mm", bottomDimensions: "88mm", height: "60mm", material: "PP", filterMembraneDiameter: "2cm" } },
    ]
  },
  {
    category: "pp-series",
    ...
    cards: [
      { id: "heat-seal-culture-bags-1", image: "/products/culture-bags/12x14-flat.webp", imageFileName: "bag-12x14-flat.jpg", sourceName: "12×14cm 平口袋", fields: { productCode: "PP-BAG-HS-1214", length: "/", width: "12cm", height: "14cm", material: "PP", filterPatchInfo: "密封 / 单孔 / 双孔可选" } },
      { id: "heat-seal-culture-bags-2", image: "/products/culture-bags/12x8x18-standup.webp", imageFileName: "bag-12x8x18-standup.jpg", sourceName: "12×8×18cm 自立袋", fields: { productCode: "PP-BAG-HS-12818", length: "12cm", width: "8cm", height: "18cm", material: "PP", filterPatchInfo: "密封 / 单孔 / 双孔可选" } },
    ]
  },
  {
    category: "pp-series",
    ...
    cards: [
      { id: "self-seal-stand-up-culture-bags-1", image: "/products/culture-bags/12x14-standup.webp", imageFileName: "bag-12x14-standup.jpg", sourceName: "12×14cm 自立袋", fields: { productCode: "PP-BAG-ZIP-1214", length: "/", width: "12cm", height: "14cm", material: "PP", filterPatchInfo: "密封 / 单孔 / 双孔可选" } },
      { id: "self-seal-stand-up-culture-bags-2", image: "/products/culture-bags/16x18.5-standup.webp", imageFileName: "bag-16x18.5-standup.jpg", sourceName: "16×18.5cm 自立袋", fields: { productCode: "PP-BAG-ZIP-16185", length: "/", width: "16cm", height: "18.5cm", material: "PP", filterPatchInfo: "密封 / 单孔 / 双孔可选" } },
    ]
  },
  {
    category: "accessories",
    ...
    cards: [
      { id: "culture-lids-1", image: "/products/culture-lids/lid-30.JPG", imageFileName: "30.jpg", sourceName: "30#", fields: { productCode: "CAP-030", modelNumber: "30#" } },
      { id: "culture-lids-2", image: "/products/culture-lids/lid-40.JPG", imageFileName: "40.jpg", sourceName: "40#", fields: { productCode: "CAP-040", modelNumber: "40#" } },
      { id: "culture-lids-3", image: "/products/culture-lids/lid-52.JPG", imageFileName: "52.jpg", sourceName: "52#", fields: { productCode: "CAP-052", modelNumber: "52#" } },
      { id: "culture-lids-4", image: "/products/culture-lids/lid-53.JPG", imageFileName: "53.jpg", sourceName: "53#", fields: { productCode: "CAP-053", modelNumber: "53#" } },
      { id: "culture-lids-5", image: "/products/culture-lids/lid-54.JPG", imageFileName: "54.jpg", sourceName: "54#", fields: { productCode: "CAP-054", modelNumber: "54#" } },
      { id: "culture-lids-6", image: "/products/culture-lids/lid-55.webp", imageFileName: "55.jpg", sourceName: "55#", fields: { productCode: "CAP-055", modelNumber: "55#" } },
      { id: "culture-lids-7", image: "/products/culture-lids/lid-56.JPG", imageFileName: "56.jpg", sourceName: "56#", fields: { productCode: "CAP-056", modelNumber: "56#" } },
      { id: "culture-lids-8", image: "/products/culture-lids/lid-57.webp", imageFileName: "57.jpg", sourceName: "57#", fields: { productCode: "CAP-057", modelNumber: "57#" } },
      { id: "culture-lids-9", image: "/products/culture-lids/lid-58.JPG", imageFileName: "58.jpg", sourceName: "58#", fields: { productCode: "CAP-058", modelNumber: "58#" } },
      { id: "culture-lids-10", image: "/products/culture-lids/lid-60.JPG", imageFileName: "60.jpg", sourceName: "60#", fields: { productCode: "CAP-060", modelNumber: "60#" } },
      { id: "culture-lids-11", image: "/products/culture-lids/lid-61.JPG", imageFileName: "61.jpg", sourceName: "61#", fields: { productCode: "CAP-061", modelNumber: "61#" } },
      { id: "culture-lids-12", image: "/products/culture-lids/lid-63.webp", imageFileName: "63.jpg", sourceName: "63#", fields: { productCode: "CAP-063", modelNumber: "63#" } },
      { id: "culture-lids-13", image: "/products/culture-lids/lid-64.JPG", imageFileName: "64.jpg", sourceName: "64#", fields: { productCode: "CAP-064", modelNumber: "64#" } },
      { id: "culture-lids-14", image: "/products/culture-lids/lid-65.JPG", imageFileName: "65.jpg", sourceName: "65#", fields: { productCode: "CAP-065", modelNumber: "65#" } },
      { id: "culture-lids-15", image: "/products/culture-lids/lid-69.JPG", imageFileName: "69.jpg", sourceName: "69#", fields: { productCode: "CAP-069", modelNumber: "69#" } },
      { id: "culture-lids-16", image: "/products/culture-lids/lid-70.webp", imageFileName: "70.jpg", sourceName: "70#", fields: { productCode: "CAP-070", modelNumber: "70#" } },
      { id: "culture-lids-17", image: "/products/culture-lids/lid-72.JPG", imageFileName: "72.jpg", sourceName: "72#", fields: { productCode: "CAP-072", modelNumber: "72#" } },
      { id: "culture-lids-18", image: "/products/culture-lids/lid-75.webp", imageFileName: "75.jpg", sourceName: "75#", fields: { productCode: "CAP-075", modelNumber: "75#" } },
      { id: "culture-lids-19", image: "/products/culture-lids/lid-77.JPG", imageFileName: "77.jpg", sourceName: "77#", fields: { productCode: "CAP-077", modelNumber: "77#" } },
      { id: "culture-lids-20", image: "/products/culture-lids/lid-80.webp", imageFileName: "80.jpg", sourceName: "80#", fields: { productCode: "CAP-080", modelNumber: "80#" } },
      { id: "culture-lids-21", image: "/products/culture-lids/lid-82.webp", imageFileName: "82.jpg", sourceName: "82#", fields: { productCode: "CAP-082", modelNumber: "82#" } },
      { id: "culture-lids-22", image: "/products/culture-lids/lid-90.webp", imageFileName: "90.jpg", sourceName: "90#", fields: { productCode: "CAP-090", modelNumber: "90#" } },
      { id: "culture-lids-23", image: "/products/culture-lids/lid-95.JPG", imageFileName: "95.jpg", sourceName: "95#", fields: { productCode: "CAP-095", modelNumber: "95#" } },
    ]
  },
  {
    category: "accessories",
    ...
    cards: [
      { id: "sealing-film-1", image: "/products/sealing-films/12x12-hole10.webp", imageFileName: "film-12x12-1cm.jpg", sourceName: "12×12cm", fields: { productCode: "FILM-1212-H01", filmSize: "12×12cm", ventHoleDiameter: "1cm" } },
      { id: "sealing-film-2", image: "/products/sealing-films/12x12-hole20.webp", imageFileName: "film-12x12-2cm.jpg", sourceName: "12×12cm", fields: { productCode: "FILM-1212-H02", filmSize: "12×12cm", ventHoleDiameter: "2cm" } },
      { id: "sealing-film-3", image: "/products/sealing-films/12x12-hole30.webp", imageFileName: "film-12x12-3cm.jpg", sourceName: "12×12cm", fields: { productCode: "FILM-1212-H03", filmSize: "12×12cm", ventHoleDiameter: "3cm" } },
      { id: "sealing-film-4", image: "/products/sealing-films/14x14-hole10.webp", imageFileName: "film-14x14-1cm.jpg", sourceName: "14×14cm", fields: { productCode: "FILM-1414-H01", filmSize: "14×14cm", ventHoleDiameter: "1cm" } },
      { id: "sealing-film-5", image: "/products/sealing-films/14x14-hole20.webp", imageFileName: "film-14x14-2cm.jpg", sourceName: "14×14cm", fields: { productCode: "FILM-1414-H02", filmSize: "14×14cm", ventHoleDiameter: "2cm" } },
      { id: "sealing-film-6", image: "/products/sealing-films/14x14-hole30.webp", imageFileName: "film-14x14-3cm.jpg", sourceName: "14×14cm", fields: { productCode: "FILM-1414-H03", filmSize: "14×14cm", ventHoleDiameter: "3cm" } },
      { id: "sealing-film-7", image: "/products/sealing-films/16x16-hole10.JPG", imageFileName: "film-16x16-1cm.jpg", sourceName: "16×16cm", fields: { productCode: "FILM-1616-H01", filmSize: "16×16cm", ventHoleDiameter: "1cm" } },
      { id: "sealing-film-8", image: "/products/sealing-films/16x16-hole20.JPG", imageFileName: "film-16x16-2cm.jpg", sourceName: "16×16cm", fields: { productCode: "FILM-1616-H02", filmSize: "16×16cm", ventHoleDiameter: "2cm" } },
      { id: "sealing-film-9", image: "/products/sealing-films/16x16-hole30.JPG", imageFileName: "film-16x16-3cm.jpg", sourceName: "16×16cm", fields: { productCode: "FILM-1616-H03", filmSize: "16×16cm", ventHoleDiameter: "3cm" } },
    ]
  },
  {
    category: "accessories",
    ...
    cards: [
      { id: "culture-baskets-1", image: "/products/culture-baskets/510x310x70.JPG", imageFileName: "basket-510x310x70.jpg", sourceName: "510×310×70mm", fields: { productCode: "BASKET-51031070", length: "510mm", width: "310mm", height: "70mm", weight: "270g" } },
      { id: "culture-baskets-2", image: "/products/culture-baskets/490x320x50.JPG", imageFileName: "basket-490x320x50.jpg", sourceName: "490×320×50mm", fields: { productCode: "BASKET-49032050", length: "490mm", width: "320mm", height: "50mm", weight: "300g" } },
      { id: "culture-baskets-3", image: "/products/culture-baskets/520x420x60.JPG", imageFileName: "basket-520x420x60.jpg", sourceName: "520×420×60mm", fields: { productCode: "BASKET-52042060", length: "520mm", width: "420mm", height: "60mm", weight: "430g" } },
      { id: "culture-baskets-4", image: "/products/culture-baskets/520x420x70.JPG", imageFileName: "basket-520x420x70.jpg", sourceName: "520×420×70mm", fields: { productCode: "BASKET-52042070", length: "520mm", width: "420mm", height: "70mm", weight: "440g" } },
      { id: "culture-baskets-5", image: "/products/culture-baskets/530x430x70.JPG", imageFileName: "basket-530x430x70.jpg", sourceName: "530×430×70mm", fields: { productCode: "BASKET-53043070", length: "530mm", width: "430mm", height: "70mm", weight: "480g" } },
      { id: "basket-grid-a", image: "/products/culture-baskets/600x440x60-grid-a.JPG", imageFileName: "basket-600x440x60-a.jpg", sourceName: "600×440×60mm（网格A）", fields: { productCode: "BASKET-60044060-A", length: "600mm", width: "440mm", height: "60mm", weight: "500g" } },
      { id: "basket-grid-b", image: "/products/culture-baskets/600x440x60-grid-b.JPG", imageFileName: "basket-600x440x60-b.jpg", sourceName: "600×440×60mm（网格B）", fields: { productCode: "BASKET-60044060-B", length: "600mm", width: "440mm", height: "60mm", weight: "500g" } },
      { id: "culture-baskets-8", image: "/products/culture-baskets/620x520x60.JPG", imageFileName: "basket-620x520x60.jpg", sourceName: "620×520×60mm", fields: { productCode: "BASKET-62052060", length: "620mm", width: "520mm", height: "60mm", weight: "700g" } },
      { id: "culture-baskets-9", image: "/products/culture-baskets/670x450x60.webp", imageFileName: "basket-670x450x60.jpg", sourceName: "670×450×60mm", fields: { productCode: "BASKET-67045060", length: "670mm", width: "450mm", height: "60mm", weight: "700g" } },
    ]
  },
  {
    category: "featured",
    ...
    cards: [
      { id: "sugar-free-ventilated-culture-box-1", image: sugarFreeImage, imageFileName: "vented-culture-box.jpg", sourceName: "无糖透气培养盒", remark: "可配套换气泵、CO2监测器、调节阀等", fields: { productCode: "PP-BOX-VENT-240195170", capacity: "/", length: "240mm", width: "195mm", height: "170mm", material: "PP" } },
    ]
  },
];
